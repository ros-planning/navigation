#ifndef VOXEL_GRID_BASIC_CLEARER_H_
#define VOXEL_GRID_BASIC_CLEARER_H_
...
class BasicClearer : public AbstractGridUpdater
{
public:
  BasicClearer(uint32_t* voxel_grid_data) :
...
#endif /* VOXEL_GRID_BASIC_CLEARER_H_ */
